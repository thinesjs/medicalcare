...
<html lang="en">
    <head>
        ...
        <title>MedicalCare - Admin Dashboard</title>
        <!-- Favicon-->
                        ...
                        <div class="col-10">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body pb-5 px-4">
                                    ...
                                    <p class="card-text">Create or assign appointments requested by users or patients</p>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="icon-wrap px-4 pt-4 d-flex justify-content-center align-items-center">
                                            <div class="icon d-flex justify-content-center align-items-center bg-primary rounded-circle ps-3 pe-3 pt-2 pb-2">
                                                <span class="bi bi-people-fill text-light"></span>
                                            </div>
                                        </div>
                                        <div class="card-body pb-5 px-4">
                                            <h5 class="card-title">Manage Users</h5>
                                            <p class="card-text">Manage all the registered users in the system</p>
                                            <a href="users" class="btn btn-primary d-grid">Manage</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="icon-wrap px-4 pt-4 d-flex justify-content-center align-items-center">
                                            <div class="icon d-flex justify-content-center align-items-center bg-primary rounded-circle ps-3 pe-3 pt-2 pb-2">
                                                <span class="bi bi-person-gear text-light"></span>
                                            </div>
                                        </div>
                                        <div class="card-body pb-5 px-4">
                                            <h5 class="card-title">Manage Nurses</h5>
                                            <p class="card-text">Manage the registered staffs and nurses of the system</p>
                                            <a href="nurses" class="btn btn-primary d-grid">Manage</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <div class="icon-wrap px-4 pt-4 d-flex justify-content-center align-items-center">
                                            <div class="icon d-flex justify-content-center align-items-center bg-primary rounded-circle ps-3 pe-3 pt-2 pb-2">
                                                <span class="bi bi-person-hearts text-light"></span>
                                            </div>
                                        </div>
                                        <div class="card-body pb-5 px-4">
                                            <h5 class="card-title">Manage Doctors</h5>
                                            <p class="card-text">Manage or promote users to registered doctors</p>
                                            <a href="doctors" class="btn btn-primary d-grid">Manage</a>
                                        </div>
                                    </div>
                                </div>
