...
<html lang="en">
    <head>
        ...
        <title>MedicalCare - Doctor</title>
        <!-- Favicon-->
                                ...
                                <div class="container">
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body pb-5 px-4">
                                            ...
                                            <p class="card-text">View appointments assigned to you by nurses.</p>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="card mb-3">
                                                <div class="row g-0">
                                                    <div class="col-md-2">
                                                        <h1 class="fw-bolder ms-3 mt-3"><?php echo Appointment::getTotalDocAppointments($_SESSION['user']['id'])['total']; ?></h1>
                                                    </div>
                                        ...
                                        <div class="col">
                                            <div class="card mb-3">
                                                <div class="row g-0">
                                                    <div class="col-md-2">
                                                        <h1 class="fw-bolder ms-3 mt-3"><?php echo Appointment::getNoDocAppointments("pending", $_SESSION['user']['id'])['total']; ?></h1>
                                                    </div>
                                                    <div class="col-md-10 justify-content-center">
                                                        <div class="card-body">
                                        ...
                                        <div class="col">
                                            <div class="card mb-3">
                                                <div class="row g-0">
                                                    <div class="col-md-2">
                                                        <h1 class="fw-bolder ms-3 mt-3"><?php echo Appointment::getNoDocAppointments("complete", $_SESSION['user']['id'])['total']; ?></h1>
                                                    </div>
                                                    <div class="col-md-10 justify-content-center">
                                                        <div class="card-body">
