...
<html lang="en">
    <head>
        ...
        <title>MedicalCare - Doctor Appointments</title>
        <!-- Favicon-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-10">
                            ...
                            <div class="tab-content" id="v-tabs-tabContent">
                                ...
                                <div class="row">
                                    <?php if ( empty( Appointment::getAppointmentByDoctorId($_SESSION['user']['id']) ) ) : ?>
                                        <div class="alert alert-danger" role="alert">
                                            You have not been assigned to appointments.
                                        </div>
                                    <?php else : ?>
                                    <?php foreach( Appointment::getAppointmentByDoctorId($_SESSION['user']['id']) as $appointment ) : ?>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-10">
                                                        ...
                                                        <div class="text-muted">
                                                            Appointment created on <b><?php echo $appointment['created_on']; ?></b> by <b><?php echo $appointment['name']; ?></b>
                                                        </div>                              
                                                    </div>
                                                    
                                                    <div class="col-sm-2">
                                                        <a class="btn btn-outline-primary btn-sm mb-2 d-grid" href="appointment/view?id=<?php echo $appointment['aid']; ?>">View</a>
